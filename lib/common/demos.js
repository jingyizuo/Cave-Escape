...
const { Scene, Material, Mat4, color, vec3, vec4, Texture, Light } = tiny;
...
const Scene_To_Texture_Demo = defs.Scene_To_Texture_Demo =
   class Scene_To_Texture_Demo extends Scene
  {                   // **Scene_To_Texture_Demo** is a crude way of doing multi-pass rendering.
    ...
    constructor()
      {               // Request the camera, shapes, and materials our Scene will need:
        ...
        this.materials =
          {  a: new Material( bump, { ambient: .5, texture: new Texture( "assets/textures/rgb.jpg" ) }),
             b: new Material( bump, { ambient: .5, texture: new Texture( "assets/textures/earth.gif" ) }),
