...
const Canvas_Widget = (widgets.Canvas_Widget = class Canvas_Widget {
  ...
  constructor(element, initial_scenes, options = {}) {
    ...
    const rules = [
      ".canvas-widget { width: 1080px; background: DimGray; margin:auto }",
...
const Code_Widget = (widgets.Code_Widget = class Code_Widget {
  ...
  constructor(element, main_scene, additional_scenes, options = {}) {
    const rules = [
      ".code-widget .code-panel { margin:auto; background:white; overflow:auto; font-family:monospace; width:1060px; padding:10px; padding-bottom:40px; max-height: 500px; \
    ...
    import("../src/main-scene.js").then((module) => {
